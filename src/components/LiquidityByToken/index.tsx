...
import { initialLiquidity } from 'src/components/Aggregator/constants';
import { useGetInitialTokenLiquidity, useGetTokensLiquidity } from 'src/queries/useGetTokenLiquidity';
...
import { useGetMcap } from 'src/queries/useGetMCap';
